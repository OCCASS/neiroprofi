            ...
            <Section className={styles.section}>
                <div className={styles.section__first}>
                    <H3 className={styles.section__title}>
                        Boсприятие человеком себя как энергичного полного здоровья — это один из первых шагов на пути
                        выздоровления. Это особенно касается неврологических заболеваний.
                    </H3>
                    <p className={styles.first__content}>
                        Королевство, в первом приближении, отталкивает крестьянский
                        ...
                        городской бальнеоклиматический курорт.
                    </p>
                </div>
                <div className={styles.section__second}>
                    ...
                    <Image className={`${styles.second__image} ${styles.second__imageSecond}`} src="/clinic2.png" alt="" width={428} height={287} />
