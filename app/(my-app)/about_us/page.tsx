        ...
        <PageLayout UnderHeaderComponent={UnderHeader}>
            <Section className={styles.section}>
                ...
                <div className={styles.first__content}>
                    ...
                    <p><b>При помощи наших  лечебных программ  мы оказываем помощь пациентам самого разного профиля: неврологическим (ведущее направление), гинекологическим, эндокринологическим, ревматологическим.</b></p>
                    ...
                    <p><b>Специфика нашего подхода – это индивидуальный персонифицированный подход к лечению пациента.</b></p>
                    ...
                    <p><b>Принципы работы нашей клиники:</b></p>
