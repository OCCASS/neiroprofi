                ...
                <ul className={styles.about_doctors__advantages}>
                    <li>
                        <AdvantageCard
                            ...
                            content="Неврологи, терапевты, гинекологи, эндокринологи, педиаторы, ЛОР врачи, остеопаты, психологи, которые придерживаются единых принципов ведения пациентов, все объясняют и налаживают контакт с пациентом."
