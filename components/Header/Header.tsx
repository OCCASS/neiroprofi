...
const Header = () => {
    return (
        <header className={styles.header}>
            <Icon className={styles.header__logo} name="logo" width={131} height={81}/>
            ...
            <nav className={styles.header__nav}>
                <ul className={styles.nav__list}>
                    ...
                    <li className={styles.nav__item}><Link href="" className={styles.nav__link}>Прайс</Link></li>
                    <li className={styles.nav__item}><Link href="" className={styles.nav__link}>Отзывы</Link></li>
                    <li className={styles.nav__item}><Link href="" className={styles.nav__link}>Частые вопросы</Link>
                    </li>
                    <li className={styles.nav__item}><Link href="" className={styles.nav__link}>Контакты</Link></li>
                </ul>
            </nav>
